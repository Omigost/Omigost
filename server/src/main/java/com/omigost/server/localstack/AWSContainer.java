 ...
 * <p>{@link AWSContainer#withServices(Service...)} should be used to select which services
 * are to be launched. See {@link Service} for available choices. It is advised that
 * {@link AWSContainer#getEndpointConfiguration(Service)} and
 * {@link AWSContainer#getDefaultCredentialsProvider()}
...
public class AWSContainer extends GenericContainer<AWSContainer> {
    ...
    public AWSContainer(String version) {
     ...
     */
    public AWSContainer withServices(Service... services) {
